...
<!--
body {
	background: url("27603905392fa0153f2545313e3a1836.jpg");
...
<form id="form1" name="rec_val" method="get" action="http://localhost/gr_form.php">
  <table width="417" border="1" align="center" cellspacing="1" bordercolor="#333333">
    ...
    <tr>
      <th height="36" bordercolor="#333333" scope="col"><select name="pur_id" class="styledrop3">
